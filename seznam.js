const filmy = [
	{
		...
		nazev: 'Strange days',
		plakat: {
			url: 'https://fiu-original.b-cdn.net/fontsinuse.com/use-images/142/142381/142381.jpeg?filename=175737615-origpic-807db5.jpg',
			sirka: 663,
			vyska: 909,
		},
		ochutnavka: 'Sci-fi z pera Kathryn Bigelow.',
		popis:
			'Píše se rok 1999. Bývalý policajt Lenny Nero tráví poslední dny starého milénia překupnictvím paměťových disků, které obsahují nahrané vzpomínky a pocity. Jednoho dne obdrží disk, na kterém je zážitek vraha prostitutky. Lenny se pustí do pátrání a dostává se hlouběji a hlouběji do spirály vydírání, vražd a násilí. Podaří se mu přežít a případ vyřešit? Příběh filmu je natolik originální, že si s ním diváci v polovině 90. let nedokázali poradit. Nakonec šlo o takový propadák, že Bigelowové málem zničil kariéru. Název filmu pochází z alba Strange Days od The Doors a cover verze titulní písně z tohoto alba je k slyšení v průběhu filmu.(Cinemax)',
		premiera: '1995-10-13',
	},
	{
		id: 'cbgb',
		nazev: 'CBGB',
		plakat: {
			url: 'https://image.pmgstatic.com/cache/resized/w420/files/images/film/posters/159/187/159187379_83ba06.jpg',
			sirka: 663,
			vyska: 909,
		},
		ochutnavka: 'O vzniku kultovního newyorského klubu.',
		popis:
	...
	{
		id: 'hidden-figues',
		nazev: 'Hidden Figures',
		plakat: {
			url: 'https://m.media-amazon.com/images/M/MV5BMzg2Mzg4YmUtNDdkNy00NWY1LWE3NmEtZWMwNGNlMzE5YzU3XkEyXkFqcGdeQXVyMjA5MTIzMjQ@._V1_.jpg',
			sirka: 663,
			vyska: 909,
		},
		ochutnavka: 'Životopisný film z roku 2016.',
		popis:
			'Snímek Skrytá čísla vypráví neuvěřitelný příběh Katherine Johnson (Taraji P. Henson), Dorothy Vaughan (Octavia Spencer) a Mary Jackson (Janelle Monáe), tří geniálních Afroameričanek, které pracovaly v NASA a jejichž výpočty stály za vysláním astronauta Johna Glenna na oběžnou dráhu. Významně tak pomohly zamíchat pořadím souboje v dobývání vesmíru. Trojice vizionářek nedbala na rasové a genderové předsudky a stala se inspirací pro další generace. (Bontonfilm)',
		premiera: '2017-01-06',
	},
	{
		id: 'pelisky',
